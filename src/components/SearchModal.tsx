...
import { Search, X, Loader2, BookOpen, Clock, ArrowRight, History } from "lucide-react";
...
export const SearchModal: React.FC<SearchModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-0 sm:p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div
        ...
        <div className="p-4 border-b border-slate-200 dark:border-slate-800 flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Search course code or title (e.g. TU856, Computer Science)..."
