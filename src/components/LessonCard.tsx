...
export const LessonCard: React.FC<LessonCardProps> = ({
  ...
  return (
    <div
      data-tour={dataTour}
      onClick={onClick}
      className={`relative overflow-hidden rounded-xl border-2 border-black bg-white transition-colors cursor-pointer active:scale-[0.99] p-3.5 my-2 ${
        isActiveNow
          ? "ring-2 ring-black"
          : isPast
          ? "opacity-60"
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 mb-1.5 pl-1">
        <div className="flex items-center gap-2">
          ...
          {isActiveNow && (
            <span className="inline-flex items-center gap-1 text-[10px] font-black text-white bg-black px-1.5 py-0.5 rounded">
      ...
      <div className="mb-2 pl-1">
        <h3 className="font-black text-sm sm:text-base text-black leading-snug">
          {lesson.Description}
        </h3>
      </div>

      {/* Bottom: Group - Room */}
      <div className="flex items-center gap-1.5 text-xs font-semibold text-black pl-1 truncate">
