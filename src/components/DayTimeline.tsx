...
export const DayTimeline: React.FC<DayTimelineProps> = ({
  ...
  return (
    <div className="w-full max-w-full flex-1 flex flex-col">
      ...
      <div
        className="z-20 bg-black border-b-2 border-white flex items-center justify-between px-3 sm:px-6 py-2.5 transition-colors shadow-xs w-full max-w-full timeline-subheader-surface"
        style={{
