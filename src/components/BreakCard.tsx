...
export const BreakCard: React.FC<BreakCardProps> = ({ dayBreak }) => {
  ...
  return (
    <div className="flex items-center justify-center my-2">
      <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-zinc-950 text-white text-[11px] font-bold border border-white/15 shadow-xs timetable-widget">
