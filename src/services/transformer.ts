...
export const EVENT_TYPE_PALETTES: Record<"laboratory" | "lecture" | "tutorial", ColorPalette> = {
  laboratory: {
    name: "laboratory",
    bg: "bg-emerald-50/90 hover:bg-emerald-50 dark:bg-[#834655]/35 dark:hover:bg-[#834655]/50 border-emerald-300/80 dark:border-[#9F5069]/60",
    accent: "bg-emerald-500 dark:bg-[#9F5069]",
    pill: "bg-emerald-100 text-emerald-800 dark:bg-[#9F5069]/30 dark:text-[#F6CAC9] border border-emerald-300/60 dark:border-[#9F5069]/60",
    icon: "text-emerald-600 dark:text-[#F6CAC9]",
    border: "border-emerald-300 dark:border-[#9F5069]/60",
    text: "text-emerald-950 dark:text-[#F6CAC9]",
  },
  lecture: {
    name: "lecture",
    bg: "bg-blue-50/90 hover:bg-blue-50 dark:bg-[#C8B273]/15 dark:hover:bg-[#C8B273]/25 border-blue-300/80 dark:border-[#C8B273]/45",
    accent: "bg-blue-600 dark:bg-[#C8B273]",
    pill: "bg-blue-100 text-blue-800 dark:bg-[#C8B273]/25 dark:text-[#C8B273] border border-blue-300/60 dark:border-[#C8B273]/50",
    icon: "text-blue-600 dark:text-[#C8B273]",
    border: "border-blue-300 dark:border-[#C8B273]/60",
    text: "text-blue-950 dark:text-[#fbf7ed]",
  },
  tutorial: {
    name: "tutorial",
    bg: "bg-amber-50/90 hover:bg-amber-50 dark:bg-[#F6CAC9]/15 dark:hover:bg-[#F6CAC9]/25 border-amber-300/80 dark:border-[#F6CAC9]/45",
    accent: "bg-amber-500 dark:bg-[#F6CAC9]",
    pill: "bg-amber-100 text-amber-900 dark:bg-[#F6CAC9]/25 dark:text-[#F6CAC9] border border-amber-300/60 dark:border-[#F6CAC9]/50",
    icon: "text-amber-600 dark:text-[#F6CAC9]",
    border: "border-amber-300 dark:border-[#F6CAC9]/60",
